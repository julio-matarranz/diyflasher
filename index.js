...
connectButton.onclick = async () => {
  ...
  } else if (["nerdminer2_1.4_tdisplays3", "nerdminer2_1.5.1-beta_tdisplays3", "nerdminer2_1.5.2_tdisplays3", "nerdminer2_1.6.0_tdisplays3"].includes(diymodelsel.value)) { // nerd
    addressesAndFiles = [
